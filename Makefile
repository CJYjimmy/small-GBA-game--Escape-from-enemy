...
PROGNAME = WorldsHardestGameEscapeFromHell
...
OFILES = gba.o font.o logic.o graphics.o main.o images/enemy.o images/gbaTitle.o images/key.o images/lose.o images/soldier.o images/win.o images/boom.o
